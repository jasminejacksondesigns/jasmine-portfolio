    ...
    <CaseStudyShell slug="invoicing-automation" sections={SECTIONS} lockProcess>
        ...
        <section id="inspiration" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          <div className="space-y-3">
            ...
            <h2 className="font-display text-2xl font-light text-ink tracking-tight">Inspiration and competitive analysis</h2>
        ...
        <section id="current-state" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          <div className="space-y-3">
            <span className="font-subheading text-xs text-muted uppercase tracking-wider">Process Artifacts</span>
            <h2 className="font-display text-2xl font-light text-ink tracking-tight">The current state of invoicing was tedious</h2>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <div className="relative aspect-[5120/1806] cs-figure overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-current-state-design-v2.png"
        ...
        <section id="hackathon" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          <div className="space-y-3">
            <span className="font-subheading text-xs text-muted uppercase tracking-wider">Hackathon: Ideal State Design</span>
            <h2 className="font-display text-2xl font-light text-ink tracking-tight">Imagining what an AI first mobile experience would look like</h2>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight max-w-3xl">Problem: customers needed to wait several seconds for the AI to generate the transaction</h3>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <div className="relative aspect-[3288/3316] cs-figure overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-loading-state-iterations-v2.png"
                alt="Iterations of the magnifying glass loading-state effect"
                fill
                sizes="(min-width: 768px) 896px, 100vw"
                quality={95}
                className="object-contain"
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight max-w-3xl">Solution: Show them how we are making progress towards the extraction to increase confidence</h3>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <IphoneFrameVideo src="/invoicing-automation/invoicing-hackathon-demo-phone-v2.mp4" />
        ...
        <section id="iterations" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          <div className="space-y-3">
            ...
            <h2 className="font-display text-2xl font-light text-ink tracking-tight">Adapting designs to provide a solution in QuickBooks Mobile</h2>
          </div>

          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight max-w-3xl">Problem: Ideal state designs from the hackathon needed to be embedded into the current system</h3>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <div className="relative aspect-[8652/4332] cs-figure overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-lofi-iteration-inproduct-v2.png"
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight max-w-3xl">Solution: Use existing patterns to develop confidence and comfort for customers</h3>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight max-w-3xl">Researching the entry point led to creation of a new AI section on the invoice</h3>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <div className="cs-figure relative aspect-[622/670] max-w-xl mx-auto overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-entry-point-research-options-v4.svg"
          ...
          <div className="space-y-3">
            <div className="relative aspect-[2372/2388] max-w-xl mx-auto cs-figure overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-two-final-directions-v2.png"
          ...
          <div className="space-y-3">
            <IphoneFrameVideo src="/invoicing-automation/invoicing-final-design-phone.mp4" />
            <p className="text-xs text-muted text-center">Final Design.</p>
          </div>
        </section>

        {/* SCALING THE DESIGN: ADDING VOICE CAPABILITIES */}
        <section id="voice-capabilities" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          <div className="space-y-3">
            <span className="font-subheading text-xs text-muted uppercase tracking-wider">Scaling the design</span>
            <h2 className="font-display text-2xl font-light text-ink tracking-tight">Adding Voice Capabilities</h2>
            <p className="text-ink/80 leading-relaxed text-sm max-w-3xl">
          ...
          <div className="space-y-3">
            <div className="relative aspect-[4776/4120] cs-figure overflow-hidden rounded-xl">
              <Image
                src="/invoicing-automation/ia-voice-iterations-v2.png"
                alt="Iterations for extending the design to include voice"
                fill
                sizes="(min-width: 768px) 1792px, 200vw"
                quality={95}
                unoptimized
                className="object-contain"
              />
          ...
          <div className="space-y-3">
            <div className="relative aspect-[1614/1654] max-w-xl mx-auto cs-figure overflow-hidden rounded-xl">
              <Image
        ...
        <section id="final-design" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 items-start">
            ...
            <div className="space-y-3">
              <IphoneFrameVideo
                src="/invoicing-automation/invoicing-voice-final-phone.mp4"
                aspectRatio="882 / 1920"
                screenScale={1}
              />
              <p className="text-xs text-muted text-center">Choosing a source, then speaking the details.</p>
            </div>
          </div>
        </section>
