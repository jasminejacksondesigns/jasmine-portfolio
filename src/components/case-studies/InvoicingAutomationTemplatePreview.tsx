  ...
  return (
    <CaseStudyShell slug="invoicing-automation" sections={SECTIONS} lockProcess>
        ...
        <section id="hackathon" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight">Problem: customers needed to wait several seconds for the AI to generate the transaction</h3>
            <p className="text-ink/80 leading-relaxed text-sm">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight">Solution: Show them how we are making progress towards the extraction to increase confidence</h3>
            <p className="text-ink/80 leading-relaxed text-sm">
        ...
        <section id="iterations" className="space-y-8 pt-10 border-t border-border scroll-mt-32">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight">Problem: Ideal state designs from the hackathon needed to be embedded into the current system</h3>
            <p className="text-ink/80 leading-relaxed text-sm">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight">Solution: Use existing patterns to develop confidence and comfort for customers</h3>
            <p className="text-ink/80 leading-relaxed text-sm">
          ...
          <div className="space-y-3">
            <h3 className="font-subheading text-lg font-light text-ink tracking-tight">Researching the entry point led to creation of a new AI section on the invoice</h3>
            <p className="text-ink/80 leading-relaxed text-sm">
