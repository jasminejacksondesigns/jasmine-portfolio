  ...
  return (
    <div className="mx-auto max-w-[1680px] px-4 pt-32 pb-24 sm:px-6 sm:pt-40 sm:pb-32">
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1fr_2fr] lg:gap-8">
        ...
        <Reveal delay={0.05}>
          <h1 className="font-display flex flex-wrap items-center gap-2 text-[28px] font-light tracking-tight text-ink sm:text-[32px]">
            {about.heading}
            <Image
      ...
      <div className="mt-16 border-t border-border pt-16 sm:mt-20 sm:pt-20">
        <Reveal>
          <PhotoCarousel
            photos={about.photos}
